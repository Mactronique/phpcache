...
$coverageField = new atoum\report\fields\runner\coverage\html('WorkflowManager', '/web/cc');
...
$testGenerator->setTestClassesDirectory('src/InExtenso/Bundle/MgedBundle/Tests/Entity');
